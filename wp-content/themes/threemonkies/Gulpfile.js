...
gulp.task('js', function () {
  gulp.src([
     ...
     // './assets/js/vendor/imagesloaded.min.js',
      ...
      './assets/js/vendor/fa-solid.min.js',
...
gulp.task('css', function () {
    gulp.src(['./assets/css/main.css', './assets/css/magnific-popup.css', './assets/css/flatpickr.min.css','./assets/css/slick.css','./assets/css/animate.css','./assets/css/select2.min.css'])
